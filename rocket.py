...
while player_y < 600:
    ...
    if keys [0]:
        if player_y > 0:    # If the coordinate is greater than 8 (not outside the playing field)
            player_y -= 7 #Change the y position by pixels. The player moves upwards en moves up
